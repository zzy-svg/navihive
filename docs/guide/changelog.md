...
NaviHive 现已提供完整的在线文档站点，基于 VitePress 构建。
...
- **CI/CD**：GitHub Actions 自动部署文档
- **SEO 优化**：完整的 meta 标签和描述
- **导航优化**：清晰的侧边栏和顶部导航
- **搜索功能**：内置文档搜索

### 文档地址

- **GitHub Pages**：https://zqq-nuli.github.io/Cloudflare-Navihive/
- **文档源码**：`docs/` 目录
...
- `1.1.0` → `1.2.0`：新增文档功能（向下兼容）
- `1.2.0` → `2.0.0`：重大架构变更（可能不兼容）
